...
**优先级**：中
**创建日期**：2026-06-03
**修复日期**：2026-06-27（PR #76，commit a254534c）
...
| 2026-06-27 | Open | Fixed | agent | PR #76 合入：Edit 工具增加 tab/空格模糊匹配，精确匹配失败时按等效缩进重试 |

## 修复记录

- 2026-06-27 PR #76（commit a254534c）：`edit.rs` 增加 tab↔空格归一化匹配逻辑，`edit_test.rs` 补充 86 行测试覆盖 tab 缩进场景
