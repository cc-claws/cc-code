...
**修复日期**：2026-06-27（PR #74 / #81，commit d13de192 / 56a1a07f / 987050af）
...
| 2026-06-27 | Open | Fixed | agent | PR #74/#81 合入：`SqliteThreadStore::new()` 创建数据库后应用 0o600，WAL/SHM 同步处理，grandparent 目录权限校验 |
