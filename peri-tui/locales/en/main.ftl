...
tip-5 = Press Alt+V to paste clipboard image (bypasses terminal Ctrl+V intercept)
tip-6 = PageUp/Down scroll messages, Home/End jump to top/bottom, Ctrl+Up/Down browse input history
