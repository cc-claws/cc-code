...
pub struct UiState {
    ...
    pub queued_messages_area: Option<ratatui::layout::Rect>,
    pub queued_message_actions: Vec<(ratatui::layout::Rect, super::QueuedMessageAction)>,
...
impl UiState {
    pub fn new(
        ...
        Self {
            ...
            queued_message_actions: Vec::new(),
