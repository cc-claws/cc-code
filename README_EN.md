...
Powered by DeepSeek-V4-Pro + GLM-5.1 + MiMo-V2.5-Pro. Zero migration — your `.claude/` config just works. Even runs on RISC-V.
...
| **Model lock-in** | Tied to one LLM | Any: Anthropic, OpenAI-compatible, DeepSeek, GLM, MiMO |
...
| **Multi-LLM** | Anthropic / OpenAI-compatible APIs — DeepSeek, GLM, MiMO, whatever works for you |
...
> Recent commits are almost entirely DeepSeek, GLM and MiMO. Claude was just there in the beginning.
